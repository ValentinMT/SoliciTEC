		    ...
		    <div class="nav-wrapper">
		    	...
		    	<a href="/empleado/indexEmpleado" data-activates="mobile-demo" class="button-collapse" style="margin-left: 20px"><i class="fa fa-bars"></i></a>
		      	<ul id="nav-mobile" class="right hide-on-med-and-down">
                	<li class=@if($route2 == 'empleados/quejas') {{'opcion-activa'}} @endif><a href="/empleados/quejas"><i class="fa fa-thumbs-down"></i>  Realizar Queja</a></li>
			    ...
			    <ul class="side-nav" id="mobile-demo">
                	<li><a href="/empleados/quejas"><i class="fa fa-thumbs-down"></i>  Realizar Queja</a></li>
	...
	<footer class="page-footer grey darken-3">
        <div class="container">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul>
                	<li><a class="grey-text text-lighten-3" href="/empleados/quejas"><i class="fa fa-thumbs-down"></i>  Realizar Queja</a></li>
