		...
		<div class="row">
		 	<div class="col s12">
				...
				<form id="altadepartamento" action="/insertarDepto" method="POST" class="responsive-form">
					...
					<div class="col s12">
						<label style="font-size: 27px; color: #43a047;"><b>ALTA DE DEPARTAMENTO</b></label>
					</div>
					<img src="/imagenes/Sombra3.png" class="responsive-img">
					<div class="input-field col s12">
						<input type="text" class="validate" name="nombre" required placeholder="ej. Sistemas">
						<label id="texto"><i class="fa fa-home"></i>  Nombre: </label>
				  	</div>
				  	<div class="input-field col s6">
						<input onkeypress="return valida(event)" maxlength="7" type="text" class="validate" name="extension" placeholder="ej. 31556(01)">
						<label id="texto" class="tooltipped" data-position="left" data-delay="50" data-tooltip="31556(extensión)"><i class="fa fa-phone"></i>  Extensión: </label>
				  	</div>
				  	<div class="input-field col s6">
